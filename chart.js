    ...
    var loadingFileName = 'js/' + url.split('/').pop() + '.js';
    var callback;
    ...
    switch (url) {
        ...
        case 'https://www.iplusonego.com/seller/sellergroups':
            callback = e => {
                sellergroupscontainer.landing()
            };
            break;
        case 'https://www.iplusonego.com/seller/members':
            callback = e => {
                memberscontainer.landing()
            };
            break;
    ...
    $.ajax({
        url: document.rawUrl + loadingFileName,
        cache: false
    }).then(callback);
